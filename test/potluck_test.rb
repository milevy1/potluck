...
class PotluckTest < Minitest::Test
  ...
  def test_potluck_has_a_menu
    ...
    assert_equal potluck.menu, {:appetizers=>["Bean Dip", "Couscous Salad", "Summer Pizza"],:entres=>["Cocktail Meatballs", "Roast Pork"],:desserts=>["Candy Salad"]}
  end
